...
sys_pdl:		equ 0x0000000000010000	; 0x010000 -> 0x01FFFF	64K Page directory low
sys_pdh:		equ 0x0000000000020000	; 0x020000 -> 0x05FFFF	256K Page directory high
						; 0x060000 -> 0x06FFFF	64K Free
ahci_cmdlist:		equ 0x0000000000070000	; 0x070000 -> 0x071FFF	4K AHCI
ahci_receivedfis:	equ 0x0000000000071000	; 0x071000 -> 0x072FFF	4K AHCI
ahci_cmdtable:		equ 0x0000000000072000	; 0x072000 -> 0x07FFFF	4K+ AHCI
						; 0x080000 -> 0x09FFFF	128K Free
sys_ROM:		equ 0x00000000000A0000	; 0x0A0000 -> 0x0FFFFF	320K System ROM
...
os_MemoryMap:		equ 0x0000000000120000	; 0x120000 -> 0x13FFFF	128K Memory Map - Room to map 256 GiB with 2 MiB pages
						; 0x140000 -> 0x19FFFF	384K Free
